...
if uploaded_file is not None:
    ...
    if chart_type == "Average Salary Trend (2020–2024)":
        ...
        for i, value in enumerate(average_salary_per_year.values):
            plt.text(average_salary_per_year.index[i], value, f"${value:,.0f}", color='black', fontsize=12, ha='center')
        ...
        for i, value in enumerate(top_10_highest.values):
            plt.text(value, i, f"${value:,.0f}", fontsize=12, color="black", va="center")
        ...
        for i, value in enumerate(average_salary_by_work_model.values):
            plt.text(i, value, f"${value:,.0f}", fontsize=12, color="black", va="center", ha="center")
